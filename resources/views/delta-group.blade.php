...
<body class="scroll-smooth" data-company="PT Delta Group Banjarmasin" data-color="bg-blue-900"
    ...
    <div class="max-w-7xl mx-auto md:px-10">
      <div class="flex justify-between items-center h-16">
        <div class="flex-shrink-0 flex items-center space-x-2">
          <img src="img/logo.webp" alt="Delta Group Logo" class="h-10 rounded-full">
  ...
  <section id="home" class="relative h-screen flex items-center justify-center overflow-hidden">
    <img src="img/background.webp" alt="Kapal besar mengangkut batu bara melintasi lautan dengan matahari terbenam"
      class="absolute inset-0 w-full h-full object-cover opacity-80">
    <div class="absolute inset-0 blue-gradient opacity-80"></div>
    <div class="container mx-auto px-6 relative z-10 text-center text-white">
      <div class="flex justify-center mb-6 mt-10">
        <img src="img/logo.webp" alt="Delta Group Company logo modern dengan ikon segitiga biru gradasi dan teks putih"
    ...
    <div class="container mx-auto px-6">
      ...
      <div class="flex flex-col md:flex-row items-center gap-12">
        <div class="md:w-1/2" data-gsap="fade-up">
          <img src="img/about.webp" alt="Pelabuhan batu bara modern dengan kapal besar sedang bersandar"
  ...
  <section class="py-10 bg-gray-100 mt-5">
    ...
    <div class="relative w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden" id="svgContainer">
      <img src="img/jalur-kapal-7.webp" alt="sungai" class="absolute object-cover w-full z-0">
      ...
      <img id="ship" src="img/kapal.webp" alt="kapal" class="absolute w-8 sm:w-14 md:w-16 top-0 left-0 z-30">
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-10">
        ...
        <div
          ...
          <div
            ...
            <img src="img/jasa-sandblasting-lampung.webp" alt="CV Delta Barito Global" class="rounded-md object-cover">
          </div>
          <div
        ...
        <div
          ...
          <div
            class="text-blue-900 text-4xl font-bold top-5 absolute w-[270px] h-[180px] group-hover:scale-[0.9] transition-all duration-300 shadow-lg">
            <img src="img/jasa-sandblasting-lampung.webp" alt="PT Delta Indo Marine" class="rounded-md object-cover">
          </div>
          <div
            class="absolute top-[210px] w-full h-[35px] p-[10px] text-center transition-all duration-300 group-hover:top-[200px] group-hover:h-[170px] flex flex-col items-center justify-center">
        ...
        <div
          ...
          <div
            class="text-blue-900 text-4xl font-bold top-5 absolute w-[270px] h-[180px] group-hover:scale-[0.9] transition-all duration-300 shadow-lg">
            <img src="img/jasa-sandblasting-lampung.webp" alt="PT Delta Borneo Global" class="rounded-md object-cover">
          </div>
          <div
            class="absolute top-[210px] w-full h-[35px] p-[10px] text-center transition-all duration-300 group-hover:top-[200px] group-hover:h-[170px] flex flex-col items-center justify-center">
      ...
      <div class="w-full">
        <div class="flex items-center justify-center gap-20 p-5">
          <div class="overflow-hidden p-2 items-center flex justify-center h-[150px] w-auto">
            <img src="img/adaro.webp" class="w-24 h-auto object-contain" fade-1 />
            <img src="img/bek.webp" class="w-24 h-auto object-contain opacity-0" fade-2 />
          </div>
          <div class="overflow-hidden p-2 items-center flex justify-center h-[150px] w-auto">
            <img src="img/jhonlin.webp" class="w-24 h-auto object-contain" fade-3 />
            <img src="img/kpc.webp" class="w-24 h-auto object-contain opacity-0" fade-4 />
          </div>
          <div class="overflow-hidden p-2 items-center flex justify-center h-[150px] w-auto">
            <img src="img/dh.webp" class="w-24 h-auto object-contain" fade-5 />
            <img src="img/arutmin.webp" class="w-24 h-auto object-contain opacity-0" fade-6 />
          </div>
          <div class="overflow-hidden p-2 items-center flex justify-center h-[150px] w-auto">
            <img src="img/hasnur.webp" class="w-24 h-auto object-contain" fade-7 />
            <img src="img/mpp.webp" class="w-24 h-auto object-contain opacity-0" fade-8 />
          </div>
          <div class="overflow-hidden p-2 items-center flex justify-center h-[150px] w-auto">
            <img src="img/tjm.webp" class="w-24 h-auto object-contain" fade-9 />
            <img src="img/berau.webp" class="w-24 h-auto object-contain opacity-0" fade-10 />
          </div>
